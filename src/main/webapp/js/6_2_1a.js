...
function download2(btn){
	...
	http.open("GET", "/xhyxt/admin/deletefile6_2_1a?path="+path+"&name="+name+"&type="+type, true);
//	http.setRequestHeader("Content-type", "application/x-www-form-urlencoded;");
	http.send();
	http.onreadystatechange = function() {
		if(http.readyState == 4 && http.status == 200) {
			window.location.href="/xhyxt/admin/deletefile6_2_1a?path="+path+"&name="+name+"&type="+type;
		}
	}
}