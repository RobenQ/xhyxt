	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>教学实践</span>
					<li id="application_book" onclick="change_src_1()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">实验指导书</li>
					<li id="outline" onclick="change_src_2()">虚拟仿真</li>
					<li id="teach_plan" onclick="change_src_3()">Matlab仿真</li>
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="/xhyxt/user/to5_1_1s"id="right_iframe">
