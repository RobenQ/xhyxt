	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>教学资源</span>
					<li id="application_book" onclick="change_src_1()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">课件PPT</li>
			...
			<div class="right_body" id="right_body">
				<iframe src="/xhyxt/user/to4_1_1s" id="right_iframe">
