	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>教学资源</span>
					<li id="application_book" onclick="change_src_1()">课件PPT</li>
					<li id="outline" onclick="change_src_2()">电子教案</li>
					<li id="teach_plan" onclick="change_src_3()">教学视频</li>
					<li id="teach_text" onclick="change_src_4()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">参考教材</li>
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/four/jiaocai.pdf"id="right_iframe">
