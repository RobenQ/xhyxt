	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>习题与试题</span>
					<li id="application_book" onclick="change_src_1()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">习题详解</li>
					<li id="outline" onclick="change_src_2()">试题汇总</li>
					<!-- <li id="teach_plan" onclick="change_src_3()">授课计划</li> -->
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="/xhyxt/user/to6_1_1s"id="right_iframe">
