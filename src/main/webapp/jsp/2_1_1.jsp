	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>课程概况</span>
					<li id="application_book" onclick="change_src_1()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">项目申报书</li>
					<li id="outline" onclick="change_src_2()"style="border-bottom: 0.5px #35383D solid;">教学大纲</li>
					<li id="teach_plan" onclick="change_src_3()">授课计划</li>
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/two/2_1.pdf"id="right_iframe">
