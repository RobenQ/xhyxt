		...
		<div class="body">
			<div class="left_list">
				<ul>
					...
					<li id="outline" onclick="change_src_2()">教学大纲</li>
					<li id="teach_plan" onclick="change_src_3()" style="color: blue;background: pink;">授课计划</li>
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/two/2_3.pdf"id="right_iframe">
