	...
	<body>
		...
		<div class="body">
			<div class="left_list">
				<ul>
					<span>教学队伍</span>
					<li id="application_book" onclick="change_src_1()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">项目负责人</li>
					<li id="outline" onclick="change_src_2()">项目组成员</li>
					<!-- <li id="teach_plan" onclick="change_src_3()">授课计划</li> -->
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/three/3_1.pdf"id="right_iframe">
