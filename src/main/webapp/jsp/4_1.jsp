...
<html>
	<head>
		...
		<script type="text/javascript">
		    ...
		    xhr.open("POST", "${pageContext.request.contextPath }/admin/uploade4_1");//修改成自己的接口
		    xhr.send(fd);
		}
	...
	<body>
		<iframe src="/xhyxt/admin/to4_1_1a" width="80%" height="600px" style="border: none; border-radius: 10px;">
		...
		<div style="width: 20%; height: 580px; border: none; border-radius: 10px; float: right;">
			...
			<form action="${pageContext.request.contextPath }/admin/uploade4_1"  enctype="multipart/form-data" method="post">
