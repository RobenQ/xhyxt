...
<html>
	<head>
		...
		<script type="text/javascript">
		   ...
		   /*  var index = document.getElementById('select').selectedIndex;
		    ...
		    xhr.open("POST", "${pageContext.request.contextPath }/admin/update44");//修改成自己的接口
		    xhr.send(fd);
		}
	...
	<body>
		<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/four/jiaocai.pdf" width="80%" height="580px" style="border: none; border-radius: 10px;">
			
		</iframe>
		<div style="width: 20%; height: 580px; border: none; border-radius: 10px; float: right;">
			<form action="${pageContext.request.contextPath }/admin/update44" enctype="multipart/form-data" method="post">
				<input type="file" id="select" name="file" style="margin-top: 240px; margin-left: 70px; width: 150px; height: 30px;" />
				<input type="submit" style="margin-top: 30px; margin-left: 70px; width: 150px; height: 30px;
