		...
		<div class="body">
			<div class="left_list">
				<ul>
					...
					<li id="teach_plan" onclick="change_src_3()"style="color: white;background: lightblue;border-bottom: 0.5px #35383D solid;">教学视频</li>
					<li id="teach_text" onclick="change_src_4()">参考教材</li>
				</ul>
			</div>
			<div class="right_body" id="right_body">
				<iframe src="/xhyxt/user/to4_3_1s"id="right_iframe">
