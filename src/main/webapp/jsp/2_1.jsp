...
<html>
	<head>
		...
		<script type="text/javascript">
		   ...
		   /*  var index = document.getElementById('select').selectedIndex;
		    ...
		    xhr.open("POST", "${pageContext.request.contextPath }/admin/update21");//修改成自己的接口
		    xhr.send(fd);
		}
	...
	<body>
		<iframe src="../js/pdfjs/web/viewer.html?file=../../../files/two/2_1.pdf" width="80%" height="580px" style="border: none; border-radius: 10px;">
			
		</iframe>
		<div style="width: 20%; height: 580px; border: none; border-radius: 10px; float: right;">
			<form action="${pageContext.request.contextPath }/admin/update21" enctype="multipart/form-data" method="post">
