	...
	<body>
		<header>
			...
			<div class="nav">
				<ul class="nav-ul">
					<li class="left navli">
						<h3><a href="/xhyxt/user/index" class="nav-a">首页</a></h3>
					</li>
					...
					<li class="left navli" onmouseover="show('ul5')" onmouseout="disappear('ul5')">
						...
						<ul class="no" id="ul5">
							...
							<li>
								<a href="/xhyxt/user/to6_2_1">试题汇总</a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<div class="main">
			...
			<ul id="ul">
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/${img1 }" alt="1" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/${img2 }" alt="2" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/${img3 }" alt="3" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/${img4 }" alt="4" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/${img5 }" alt="5" /></li>
			</ul>
			<ol id="list">
				<li id="on">1</li>
				<li>2</li>
