...
<html>
	...
	<body>
		...
		<div class="main">
			...
			<ul id="ul">
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/1.jpg" alt="1" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/2.jpg" alt="2" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/3.jpg" alt="3" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/4.jpg" alt="4" /></li>
				<li class="left pic"><img src="${pageContext.request.contextPath }/img/lunbo/5.png" alt="5" /></li>
			</ul>
			<ol id="list">
				<li id="on">1</li>
				<li>2</li>
